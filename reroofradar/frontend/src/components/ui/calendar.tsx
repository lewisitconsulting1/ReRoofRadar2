  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          'inline-flex items-center justify-center h-7 w-7 p-0 opacity-50 hover:opacity-100'
        ),
        ...
        day: cn('inline-flex h-9 w-9 items-center justify-center p-0 font-normal aria-selected:opacity-100'),
